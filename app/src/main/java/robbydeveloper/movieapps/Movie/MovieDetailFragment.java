...
import robbydeveloper.movieapps.Adapter.RecycleListAdapter;
import robbydeveloper.movieapps.Adapter.ReviewList;
import robbydeveloper.movieapps.Entity.Favorite;
import robbydeveloper.movieapps.Entity.Review;
        ...
        btn_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (favoriteList.size() <= 0) {
                    ...
                    favorite_store.save();
                    Snackbar.make(v, "Film ini sudah ditambahkan ke daftar favorite", Snackbar.LENGTH_LONG)
                    ...
                    Snackbar.make(v, "Film ini sudah dihapuskan ke daftar favorite", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
    ...
    public class GetReview extends AsyncTask<String, Void, List<Review>> {
        ...
        protected List<Review> doInBackground(String... params) {
            ...
            try {
                ...
                final String API_KEY = "?api_key=b2fdbd55b8e0f1458372c8bd3daeafa3";
                Uri builtUri = Uri.parse(BASE_URL + API_KEY).buildUpon()
                        .build();
